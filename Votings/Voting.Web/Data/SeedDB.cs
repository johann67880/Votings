namespace Voting.Web.Data
{
    ...
    public class SeedDB
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await this.CheckUser("johaljicar@hotmail.com", "Johann", "Jimenez", "Admin");
            await this.CheckUser("jajimenez0887@misena.edu.com", "Beto", "Jimenez", "Customer");
